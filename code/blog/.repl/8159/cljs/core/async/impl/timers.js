...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5486__auto__,writer__5487__auto__,opt__5488__auto__){return cljs.core._write.call(null,writer__5487__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20364 = 0;while(true){
if((i_20364 < arr.length))
{(arr[i_20364] = null);
{
var G__20365 = (i_20364 + 1);
i_20364 = G__20365;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5486__auto__,writer__5487__auto__,opt__5488__auto__){return cljs.core._write.call(null,writer__5487__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_20371 = (self__.level + 1);while(true){
if((i_20371 <= (new_level + 1)))
{(update[i_20371] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20373 = 0;while(true){
if((i_20373 <= self__.level))
{var links_20374 = (update[i_20373]).forward;if(((links_20374[i_20373]) === x__$1))
{(links_20374[i_20373] = (x__$1.forward[i_20373]));
{
var G__20375 = (i_20373 + 1);
i_20373 = G__20375;
continue;
}
} else
{{
var G__20376 = (i_20373 + 1);
i_20373 = G__20376;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__4924__auto__ = (cljs.core.truth_((function (){var and__4912__auto__ = me;if(cljs.core.truth_(and__4912__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__4912__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__4924__auto__))
