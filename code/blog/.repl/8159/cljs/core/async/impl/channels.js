...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20405 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20405 = (function (val,box,meta20406){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20405.cljs$lang$type = true;
cljs.core.async.impl.channels.t20405.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20405";
cljs.core.async.impl.channels.t20405.cljs$lang$ctorPrWriter = (function (this__5486__auto__,writer__5487__auto__,opt__5488__auto__){return cljs.core._write.call(null,writer__5487__auto__,"cljs.core.async.impl.channels/t20405");
});
cljs.core.async.impl.channels.t20405.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20405.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20407){var self__ = this;
var _20407__$1 = this;return self__.meta20406;
});
cljs.core.async.impl.channels.t20405.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20407,meta20406__$1){var self__ = this;
var _20407__$1 = this;return (new cljs.core.async.impl.channels.t20405(self__.val,self__.box,meta20406__$1));
});
cljs.core.async.impl.channels.__GT_t20405 = (function __GT_t20405(val__$1,box__$1,meta20406){return (new cljs.core.async.impl.channels.t20405(val__$1,box__$1,meta20406));
});
}
return (new cljs.core.async.impl.channels.t20405(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__5489__auto__,writer__5490__auto__,opts__5491__auto__){return cljs.core._write.call(null,writer__5490__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__5486__auto__,writer__5487__auto__,opt__5488__auto__){return cljs.core._write.call(null,writer__5487__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_20408 = self__.takes.pop();if((taker_20408 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20408))
{var take_cb_20409 = cljs.core.async.impl.protocols.commit.call(null,taker_20408);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20409,taker_20408){
return (function (){return take_cb_20409.call(null,null);
});})(take_cb_20409,taker_20408))
);
} else
{}
{
