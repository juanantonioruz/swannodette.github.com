...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20399 = 0;while(true){
var m_20400 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20400 == null))
{} else
{m_20400.call(null);
if((count_20399 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20401 = (count_20399 + 1);
count_20399 = G__20401;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__4912__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__4912__auto__)
