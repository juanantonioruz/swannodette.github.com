...
{{
var G__20557 = cljs.core.pop.call(null,v__$1);
v__$1 = G__20557;
continue;
}
} else
...
{var pred__20561 = cljs.core._EQ_;var expr__20562 = limit;if(cljs.core.truth_(pred__20561.call(null,1,expr__20562)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__20561.call(null,2,expr__20562)))
...
var G__20564 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__20565 = (limit__$1 - 1);
var G__20566 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__20564;
limit__$1 = G__20565;
parts = G__20566;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___20568 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___20568))
{var replacement_20569 = temp__4090__auto___20568;buffer.append([cljs.core.str(replacement_20569)].join(''));
} else
{buffer.append(ch);
}
{
var G__20570 = (index + 1);
index = G__20570;
continue;
}
}
