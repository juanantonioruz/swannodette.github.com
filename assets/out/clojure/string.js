...
{{
var G__13770 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13770;
continue;
}
} else
...
{var pred__13774 = cljs.core._EQ_;var expr__13775 = limit;if(cljs.core.truth_(pred__13774.call(null,1,expr__13775)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13774.call(null,2,expr__13775)))
...
var G__13777 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13778 = (limit__$1 - 1);
var G__13779 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13777;
limit__$1 = G__13778;
parts = G__13779;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13781 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13781))
{var replacement_13782 = temp__4090__auto___13781;buffer.append([cljs.core.str(replacement_13782)].join(''));
} else
{buffer.append(ch);
}
{
var G__13783 = (index + 1);
index = G__13783;
continue;
}
}
