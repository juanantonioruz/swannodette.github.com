...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16402 = 0;while(true){
var m_16403 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16403 == null))
{} else
{m_16403.call(null);
if((count_16402 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16404 = (count_16402 + 1);
count_16402 = G__16404;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3419__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3419__auto__)
