...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3993__auto__,writer__3994__auto__,opt__3995__auto__){return cljs.core._write.call(null,writer__3994__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_16367 = 0;while(true){
if((i_16367 < arr.length))
{(arr[i_16367] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3993__auto__,writer__3994__auto__,opt__3995__auto__){return cljs.core._write.call(null,writer__3994__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_16374 = (self__.level + 1);while(true){
if((i_16374 <= (new_level + 1)))
{(update[i_16374] = self__.header);
{
var G__16375 = (i_16374 + 1);
i_16374 = G__16375;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16376 = 0;while(true){
if((i_16376 <= self__.level))
{var links_16377 = (update[i_16376]).forward;if(((links_16377[i_16376]) === x__$1))
{(links_16377[i_16376] = (x__$1.forward[i_16376]));
{
var G__16378 = (i_16376 + 1);
i_16376 = G__16378;
continue;
}
} else
{{
var G__16379 = (i_16376 + 1);
i_16376 = G__16379;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3431__auto__ = (cljs.core.truth_((function (){var and__3419__auto__ = me;if(cljs.core.truth_(and__3419__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3419__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3431__auto__))
