...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16408 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16408 = (function (val,box,meta16409){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16408.cljs$lang$type = true;
cljs.core.async.impl.channels.t16408.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16408";
cljs.core.async.impl.channels.t16408.cljs$lang$ctorPrWriter = (function (this__3993__auto__,writer__3994__auto__,opt__3995__auto__){return cljs.core._write.call(null,writer__3994__auto__,"cljs.core.async.impl.channels/t16408");
});
cljs.core.async.impl.channels.t16408.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16408.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16410){var self__ = this;
var _16410__$1 = this;return self__.meta16409;
});
cljs.core.async.impl.channels.t16408.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16410,meta16409__$1){var self__ = this;
var _16410__$1 = this;return (new cljs.core.async.impl.channels.t16408(self__.val,self__.box,meta16409__$1));
});
cljs.core.async.impl.channels.__GT_t16408 = (function __GT_t16408(val__$1,box__$1,meta16409){return (new cljs.core.async.impl.channels.t16408(val__$1,box__$1,meta16409));
});
}
return (new cljs.core.async.impl.channels.t16408(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3996__auto__,writer__3997__auto__,opts__3998__auto__){return cljs.core._write.call(null,writer__3997__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3993__auto__,writer__3994__auto__,opt__3995__auto__){return cljs.core._write.call(null,writer__3994__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16411 = self__.takes.pop();if((taker_16411 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16411))
{var take_cb_16412 = cljs.core.async.impl.protocols.commit.call(null,taker_16411);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16412,taker_16411){
return (function (){return take_cb_16412.call(null,null);
});})(take_cb_16412,taker_16411))
);
} else
{}
{
